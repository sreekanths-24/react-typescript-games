...
function Tictactoe() {
  ...
  const [winningCombinationKey, setWinningCombinationKey] = useState<LineCoords | null>(null);
  ...
  return (
      <>
      <div id="main" className="h-dvh w-full flex justify-center items-center bg-gray-900">
        <div 
            id="board" 
